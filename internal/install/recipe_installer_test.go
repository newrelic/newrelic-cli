...
func TestNewRecipeInstaller_InstallerContextFields(t *testing.T) {
	...
	i := RecipeInstaller{ic, d, l, mv, f, e, v, ff, status, p, pi, lkf, cv, rvp}
...
func TestInstall_FailsOnInvalidOs(t *testing.T) {
	...
	i := RecipeInstaller{ic, discover, l, mv, f, e, v, ff, status, p, pi, lkf, cv, rvp}
...
func TestInstall_RecipeInstalled(t *testing.T) {
	...
	i := RecipeInstaller{ic, d, l, mv, f2, e, v, ff, status, p, pi, lkf, cv, rvp}
	err := i.Install()
	require.NoError(t, err)
