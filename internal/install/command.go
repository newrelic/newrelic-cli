...
func init() {
	...
	Command.Flags().StringSliceVarP(&entityTags, "tag", "", []string{}, "the tags to add during install, can be multiple. Example: --tag tag1:test,tag2:test")
}
