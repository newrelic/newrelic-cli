...
type ConcreteRecipeRecommender struct {
...
func NewConcreteRecipeRecommender(rf RecipeFetcher, pf ProcessFilterer, re execution.RecipeExecutor) *ConcreteRecipeRecommender {
	return &ConcreteRecipeRecommender{
		recipeFetcher:   rf,
		processFilterer: pf,
		recipeExecutor:  re,
	}
...
func (r *ConcreteRecipeRecommender) Recommend(ctx context.Context, m *types.DiscoveryManifest) ([]types.OpenInstallationRecipe, error) {
	if r.allRecipes == nil {
...
func (r *ConcreteRecipeRecommender) fetchAllRecipes(ctx context.Context, m *types.DiscoveryManifest) error {
...
func (r *ConcreteRecipeRecommender) findProcessMatches(ctx context.Context, recCtx *recommendationContext) error {
...
func (r *ConcreteRecipeRecommender) findCustomScriptedMatches(ctx context.Context, recCtx *recommendationContext) error {
