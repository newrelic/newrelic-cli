...
func TestShouldFindMatchesMultipleWithCmdLineInsteadOfName(t *testing.T) {
	...
	processes := []types.GenericProcess{
		MockProcess{
			name: "java",
			cmd:  "java -xyz processSomething/cassandra",
		},
		MockProcess{
			name: "somethingElse",
			cmd:  "somethingElse",
...
func TestShouldFilterOutNewRelicInstall(t *testing.T) {
	...
	processes := []types.GenericProcess{
		MockProcess{
			name: "java",
			cmd:  "/usr/local/bin/newrelic install -c java",
		},
		MockProcess{
			name: "somethingElse",
			cmd:  "somethingElse",
...
func TestShouldFilterOutNewRelicInstallWindows(t *testing.T) {
	...
	processes := []types.GenericProcess{
		MockProcess{
			name: "java",
			cmd:  "'mypath/newrelic.exe' install -c java",
		},
		MockProcess{
			name: "somethingElse",
			cmd:  "somethingElse",
