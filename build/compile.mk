...
LDFLAGS    ?= "-s -X main.appName=$$b -X $(PROJECT_MODULE)/internal/cli.version=$(PROJECT_VER) -X $(PROJECT_MODULE)/internal/split.prodKey=$(SPLIT_PROD_KEY) -X $(PROJECT_MODULE)/internal/split.stagingKey=$(SPLIT_STAGING_KEY)"
SRCDIR     ?= .
